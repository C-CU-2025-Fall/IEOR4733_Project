...
| coherent override | 31/45 | 37/45 | 33/36 | 60.8% | 16.3% | Partly | structural_history / Equity Index:risk_price_non / annual_mean_log / contract_equal_path |
| structural-heavy | 30/45 | 37/45 | 33/36 | 57.1% | 14.6% | Partly | history_seed / Equity:risk_price_non / wealth_cagr / contract_equal_path |
...
| Label | <=10 | <=15 | 4-asset <=15 | Mean Ann Gap | Mean Cal Gap | Capital | Numerator | All Mode | 4-asset Remaining Misses |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| structural_history / Equity Index:risk_price_non / annual_mean_log / contract_equal_path | 31/45 | 37/45 | 33/36 | 60.8% | 16.3% | Equity Index->risk_price_non | annual_mean_log | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| structural_history / Equity Index:risk_price_non / annual_mean_log / asset_equal_path | 31/45 | 37/45 | 33/36 | 60.8% | 16.3% | Equity Index->risk_price_non | annual_mean_log | asset_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| structural_history / Equity Index:risk_price_non / annual_mean_log / asset_count_weighted_path | 31/45 | 37/45 | 33/36 | 60.8% | 16.3% | Equity Index->risk_price_non | annual_mean_log | asset_count_weighted_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| structural_history / Equity Index:risk_price_non / wealth_cagr / contract_equal_path | 30/45 | 37/45 | 33/36 | 57.1% | 14.6% | Equity Index->risk_price_non | wealth_cagr | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| structural_history / Equity Index:risk_price_non / wealth_cagr / asset_equal_path | 30/45 | 37/45 | 33/36 | 57.1% | 14.6% | Equity Index->risk_price_non | wealth_cagr | asset_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| structural_history / Equity Index:risk_price_non / wealth_cagr / asset_count_weighted_path | 30/45 | 37/45 | 33/36 | 57.1% | 14.6% | Equity Index->risk_price_non | wealth_cagr | asset_count_weighted_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| structural_history / Equity Index:risk_price_non / annual_mean_simple / contract_equal_path | 30/45 | 36/45 | 32/36 | 54.6% | 16.4% | Equity Index->risk_price_non | annual_mean_simple | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar ; Forex: Calmar |
| structural_history / Equity Index:risk_price_non / annual_mean_simple / asset_equal_path | 30/45 | 36/45 | 32/36 | 54.6% | 16.4% | Equity Index->risk_price_non | annual_mean_simple | asset_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar ; Forex: Calmar |
| structural_history / Equity Index:risk_price_non / annual_mean_simple / asset_count_weighted_path | 30/45 | 36/45 | 32/36 | 54.6% | 16.4% | Equity Index->risk_price_non | annual_mean_simple | asset_count_weighted_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar ; Forex: Calmar |
| structural_history / Fixed Income:risk_price_non / annual_mean_log / contract_equal_path | 29/45 | 36/45 | 32/36 | 54.3% | 20.9% | Fixed Income->risk_price_non | annual_mean_log | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: MDD, Calmar |

## Structural-Heavy Frontiers

| Label | <=10 | <=15 | 4-asset <=15 | Mean Ann Gap | Mean Cal Gap | Capital | Numerator | All Mode | 4-asset Remaining Misses |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| history_seed / Equity:risk_price_non / wealth_cagr / contract_equal_path | 30/45 | 37/45 | 33/36 | 57.1% | 14.6% | Equity Index->risk_price_non | wealth_cagr | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / annual_mean_log / contract_equal_path / contract_equal_path | 30/45 | 37/45 | 33/36 | 59.5% | 18.4% | risk_price_source | annual_mean_log | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / annual_mean_log / contract_equal_path / asset_equal_path | 30/45 | 37/45 | 33/36 | 59.5% | 18.4% | risk_price_source | annual_mean_log | asset_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / annual_mean_log / contract_equal_path / asset_count_weighted_path | 30/45 | 37/45 | 33/36 | 59.5% | 18.4% | risk_price_source | annual_mean_log | asset_count_weighted_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / wealth_cagr / contract_equal_path / contract_equal_path | 29/45 | 37/45 | 33/36 | 55.7% | 16.7% | risk_price_source | wealth_cagr | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / wealth_cagr / contract_equal_path / asset_equal_path | 29/45 | 37/45 | 33/36 | 55.7% | 16.7% | risk_price_source | wealth_cagr | asset_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / wealth_cagr / contract_equal_path / asset_count_weighted_path | 29/45 | 37/45 | 33/36 | 55.7% | 16.7% | risk_price_source | wealth_cagr | asset_count_weighted_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar |
| history_seed / annual_mean_simple / contract_equal_path / contract_equal_path | 29/45 | 36/45 | 32/36 | 53.1% | 18.4% | risk_price_source | annual_mean_simple | contract_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar ; Forex: Calmar |
| history_seed / annual_mean_simple / contract_equal_path / asset_equal_path | 29/45 | 36/45 | 32/36 | 53.1% | 18.4% | risk_price_source | annual_mean_simple | asset_equal_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar ; Forex: Calmar |
| history_seed / annual_mean_simple / contract_equal_path / asset_count_weighted_path | 29/45 | 36/45 | 32/36 | 53.1% | 18.4% | risk_price_source | annual_mean_simple | asset_count_weighted_path | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar ; Forex: Calmar |
...
| structural_history / Equity Index:risk_price_non / annual_mean_log / contract_equal_path | 31/45 | 37/45 | CC:RAD_REGEN, DT:RAD, EN:REV, JO:RAD_REGEN, LB:RAD, ZH:RAD_REGEN | FB,ZA | risk_price_source | annual_mean_log | contract_equal_path | contract_equal_path | No | Yes | Yes | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar | Partly | High | 备选方案 |
| history_seed / Equity:risk_price_non / wealth_cagr / contract_equal_path | 30/45 | 37/45 | CC:RAD_REGEN, DT:RAD, EN:REV, JO:RAD_REGEN, LB:RAD, ZH:RAD_REGEN | FB,ZA | risk_price_source | wealth_cagr | contract_equal_path | contract_equal_path | No | Yes | Yes | Commodity: MDD ; Equity Index: Calmar ; Fixed Income: Calmar | Partly | High | 仅实验上界 |
...
- coherent override max frontier: `structural_history / Equity Index:risk_price_non / annual_mean_log / contract_equal_path` → `<=15 37/45`, `<=10 31/45`
- structural-heavy max frontier: `history_seed / Equity:risk_price_non / wealth_cagr / contract_equal_path` → `<=15 37/45`, `<=10 30/45`
