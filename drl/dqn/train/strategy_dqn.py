#!/usr/bin/env python3
"""Single-contract DQN runtime helpers and compatibility entrypoints."""
...
from drl.dqn.spec import RETRAIN_ROUNDS, WARMUP, contract_model_path, ticker_asset_class, universe_tickers
...
def status(asset_name: str = "All", ticker: str | None = None):
    ...
    for tk in tickers:
        ...
        for round_num in sorted(RETRAIN_ROUNDS):
            checkpoint = contract_model_path(round_num, tk, algorithm="dqn")
