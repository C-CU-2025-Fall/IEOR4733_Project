...
### 高优先级
1. **MDD 计算方式** — 检查 Paper 原文定义，确认是否需要调整
2. **DD 计算方式** — 确认是否使用 zero-target LPM(2)
3. **C-grade 合约调查** — 10 个合约 (NR, TY, ZO, ZR, ZT, ZZ, DA, JO, LB, FB) 数据质量问题
